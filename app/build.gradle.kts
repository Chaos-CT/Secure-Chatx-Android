...
val canonicalVersionCode = 1526
val canonicalVersionName = "7.38.3"
...
android {
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_URL", "\"https://chat.lavendarsolution.org\"")
    buildConfigField("String", "STORAGE_URL", "\"https://storage.lavendarsolution.org\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://signal-server-cdn-bucket-0612.s3.eu-west-2.amazonaws.com\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://storage.googleapis.com\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3.lavendarsolution.org\"")
    ...
    buildConfigField("String", "CONTENT_PROXY_HOST", "\"contentproxy.lavendarsolution.org\"")
    ...
    buildConfigField("String", "BADGE_STATIC_ROOT", "\"https://updates2.lavendarsolution.org/static/badges/\"")
  ...
  productFlavors {
    ...
    create("website") {
      ...
      buildConfigField("String", "APK_UPDATE_MANIFEST_URL", "\"https://updates.lavendarsolution.org/android/latest.json\"")
    ...
    create("staging") {
      ...
      buildConfigField("String", "SIGNAL_URL", "\"https://chat.staging.lavendarsolution.org\"")
      buildConfigField("String", "STORAGE_URL", "\"https://storage-staging.lavendarsolution.org\"")
      buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn-staging.lavendarsolution.org\"")
      buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn2-staging.lavendarsolution.org\"")
      buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3-staging.lavendarsolution.org\"")
      buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://cdsi.staging.lavendarsolution.org\"")
      buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://svr2.staging.lavendarsolution.org\"")
