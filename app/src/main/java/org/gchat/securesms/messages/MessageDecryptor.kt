...
import org.gchat.securesms.jobs.SendRetryReceiptJob
import org.gchat.securesms.keyvalue.SignalStore
import org.gchat.securesms.logsubmit.SubmitDebugLogActivity
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [org.gchat.securesms.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
