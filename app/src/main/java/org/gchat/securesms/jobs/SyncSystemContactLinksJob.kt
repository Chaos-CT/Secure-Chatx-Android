...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.org.gchat.securesms.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.gchat.securesms.call"
    private const val VIDEO_CALL_MIMETYPE = "vnd.android.cursor.item/vnd.org.gchat.securesms.videocall"
