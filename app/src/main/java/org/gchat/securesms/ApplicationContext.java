...
import org.gchat.securesms.apkupdate.ApkUpdateRefreshListener;
import org.gchat.securesms.avatar.AvatarPickerStorage;
import org.gchat.securesms.backup.v2.BackupRepository;
import org.gchat.securesms.crypto.AttachmentSecretProvider;
import org.gchat.securesms.crypto.DatabaseSecretProvider;
import org.gchat.securesms.database.LogDatabase;
import org.gchat.securesms.database.SignalDatabase;
import org.gchat.securesms.database.SqlCipherLibraryLoader;
import org.gchat.securesms.dependencies.AppDependencies;
import org.gchat.securesms.dependencies.ApplicationDependencyProvider;
import org.gchat.securesms.emoji.EmojiSource;
import org.gchat.securesms.emoji.JumboEmoji;
import org.gchat.securesms.gcm.FcmFetchManager;
import org.gchat.securesms.jobs.AccountConsistencyWorkerJob;
import org.gchat.securesms.jobs.BackupRefreshJob;
import org.gchat.securesms.jobs.BackupSubscriptionCheckJob;
import org.gchat.securesms.jobs.BuildExpirationConfirmationJob;
import org.gchat.securesms.jobs.CheckServiceReachabilityJob;
import org.gchat.securesms.jobs.DownloadLatestEmojiDataJob;
import org.gchat.securesms.jobs.EmojiSearchIndexDownloadJob;
import org.gchat.securesms.jobs.FcmRefreshJob;
import org.gchat.securesms.jobs.FontDownloaderJob;
import org.gchat.securesms.jobs.GroupRingCleanupJob;
import org.gchat.securesms.jobs.GroupV2UpdateSelfProfileKeyJob;
import org.gchat.securesms.jobs.InAppPaymentAuthCheckJob;
import org.gchat.securesms.jobs.InAppPaymentKeepAliveJob;
import org.gchat.securesms.jobs.LinkedDeviceInactiveCheckJob;
import org.gchat.securesms.jobs.MultiDeviceContactUpdateJob;
import org.gchat.securesms.jobs.PnpInitializeDevicesJob;
import org.gchat.securesms.jobs.PreKeysSyncJob;
import org.gchat.securesms.jobs.ProfileUploadJob;
import org.gchat.securesms.jobs.RefreshSvrCredentialsJob;
import org.gchat.securesms.jobs.RestoreOptimizedMediaJob;
import org.gchat.securesms.jobs.RetrieveProfileJob;
import org.gchat.securesms.jobs.RetrieveRemoteAnnouncementsJob;
import org.gchat.securesms.jobs.StoryOnboardingDownloadJob;
import org.gchat.securesms.keyvalue.KeepMessagesDuration;
import org.gchat.securesms.keyvalue.SignalStore;
import org.gchat.securesms.logging.CustomSignalProtocolLogger;
import org.gchat.securesms.logging.PersistentLogger;
import org.gchat.securesms.messageprocessingalarm.RoutineMessageFetchReceiver;
import org.gchat.securesms.messages.GroupSendEndorsementInternalNotifier;
import org.gchat.securesms.migrations.ApplicationMigrations;
import org.gchat.securesms.mms.SignalGlideComponents;
import org.gchat.securesms.mms.SignalGlideModule;
...
import org.gchat.securesms.ringrtc.RingRtcLogger;
import org.gchat.securesms.service.AnalyzeDatabaseAlarmListener;
import org.gchat.securesms.service.DirectoryRefreshListener;
import org.gchat.securesms.service.KeyCachingService;
import org.gchat.securesms.service.LocalBackupListener;
import org.gchat.securesms.service.MessageBackupListener;
import org.gchat.securesms.service.RotateSenderCertificateListener;
import org.gchat.securesms.service.RotateSignedPreKeyListener;
import org.gchat.securesms.service.webrtc.ActiveCallManager;
import org.gchat.securesms.service.webrtc.AndroidTelecomUtil;
...
import org.gchat.securesms.util.SignalUncaughtExceptionHandler;
import org.gchat.securesms.util.TextSecurePreferences;
import org.gchat.securesms.util.Util;
import org.gchat.securesms.util.VersionTracker;
import org.gchat.securesms.util.dynamiclanguage.DynamicLanguageContextWrapper;
