...
package org.gchat.securesms.audio
...
import org.gchat.securesms.util.safeUnregisterReceiver
import org.gchat.securesms.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.gchat.securesms.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.gchat.securesms.webrtc.audio.SignalAudioManager].
 */
