package org.gchat.securesms.badges.gifts
...
import org.gchat.securesms.badges.gifts.Gifts.formatExpiry
    ...
    if (isOutgoing) {
      ...
      when (giftBadge.redemptionState) {
        ...
        GiftBadge.RedemptionState.STARTED -> actionView.icon = CircularProgressDrawable(context).apply {
          ...
          setColorSchemeColors(ContextCompat.getColor(context, R.color.core_green_accent))
