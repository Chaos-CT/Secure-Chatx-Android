package org.gchat.securesms.jobmanager;
...
import org.gchat.securesms.jobmanager.impl.DefaultExecutorFactory;
import org.gchat.securesms.jobmanager.persistence.JobSpec;
import org.gchat.securesms.jobmanager.persistence.JobStorage;
import org.gchat.securesms.jobs.MinimalJobSpec;
...
import org.gchat.securesms.util.concurrent.FilteredExecutor;
...
public class JobManager implements ConstraintObserver.Notifier {
  ...
  public JobManager(@NonNull Application application, @NonNull Configuration configuration) {
    ...
    this.executor      = new FilteredExecutor(configuration.getExecutorFactory().newSingleThreadExecutor("signal-JobManager"), () -> {
      return ThreadUtil.isMainThread() || Thread.currentThread().getName().equals("Instr: org.gchat.securesms.testing.SignalTestRunner");
    });
