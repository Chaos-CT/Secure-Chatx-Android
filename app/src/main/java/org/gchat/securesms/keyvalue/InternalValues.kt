...
import org.gchat.securesms.util.Environment.Calling.defaultSfuUrl
...
class InternalValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * Show detailed recipient info in the [org.gchat.securesms.components.settings.conversation.InternalConversationSettingsFragment].
   */
