...
class MiscellaneousValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * The last time we ran an account consistency check via [org.gchat.securesms.jobs.AccountConsistencyWorkerJob]
   */
  ...
  /**
   * The last time we prompted the user regarding a [org.gchat.securesms.util.ConnectivityWarning].
   */
