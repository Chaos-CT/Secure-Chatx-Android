...
package org.gchat.securesms.conversation.mutiselect
...
import org.gchat.securesms.conversation.ConversationAdapterBridge.PulseRequest
...
class MultiselectItemDecoration(
  ...
  private val ultramarine30 = ContextCompat.getColor(context, R.color.core_green_accent_33)
