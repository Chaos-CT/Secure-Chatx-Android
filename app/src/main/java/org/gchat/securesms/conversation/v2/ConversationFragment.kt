...
import org.gchat.securesms.BlockUnblockDialog
import org.gchat.securesms.GroupMembersDialog
import org.gchat.securesms.LoggingFragment
import org.gchat.securesms.MainActivity
import org.gchat.securesms.MuteDialog
import org.gchat.securesms.R
import org.gchat.securesms.audio.AudioRecorder
import org.gchat.securesms.badges.gifts.OpenableGift
import org.gchat.securesms.badges.gifts.OpenableGiftItemDecoration
import org.gchat.securesms.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import org.gchat.securesms.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import org.gchat.securesms.billing.upgrade.UpgradeToStartMediaBackupSheet
import org.gchat.securesms.calls.YouAreAlreadyInACallSnackbar
import org.gchat.securesms.components.AnimatingToggle
import org.gchat.securesms.components.ComposeText
import org.gchat.securesms.components.ConversationSearchBottomBar
import org.gchat.securesms.components.DeleteSyncEducationDialog
import org.gchat.securesms.components.HidingLinearLayout
import org.gchat.securesms.components.InputAwareConstraintLayout
import org.gchat.securesms.components.InputPanel
import org.gchat.securesms.components.InsetAwareConstraintLayout
import org.gchat.securesms.components.ProgressCardDialogFragment
import org.gchat.securesms.components.ProgressCardDialogFragmentArgs
import org.gchat.securesms.components.ScrollToPositionDelegate
import org.gchat.securesms.components.SendButton
import org.gchat.securesms.components.ViewBinderDelegate
import org.gchat.securesms.components.emoji.EmojiEventListener
import org.gchat.securesms.components.emoji.MediaKeyboard
import org.gchat.securesms.components.emoji.RecentEmojiPageModel
import org.gchat.securesms.components.location.SignalPlace
import org.gchat.securesms.components.mention.MentionAnnotation
import org.gchat.securesms.components.menu.ActionItem
import org.gchat.securesms.components.menu.SignalBottomActionBar
import org.gchat.securesms.components.settings.app.AppSettingsActivity
import org.gchat.securesms.components.settings.app.subscription.donate.CheckoutFlowActivity
import org.gchat.securesms.components.settings.app.subscription.donate.DonateToSignalFragment
import org.gchat.securesms.components.settings.conversation.ConversationSettingsActivity
import org.gchat.securesms.components.spoiler.SpoilerAnnotation
import org.gchat.securesms.components.voice.VoiceNoteDraft
import org.gchat.securesms.components.voice.VoiceNoteMediaControllerOwner
import org.gchat.securesms.components.voice.VoiceNotePlaybackState
import org.gchat.securesms.components.voice.VoiceNotePlayerView
import org.gchat.securesms.contacts.paged.ContactSearchKey.RecipientSearchKey
import org.gchat.securesms.contactshare.Contact
import org.gchat.securesms.contactshare.ContactUtil
import org.gchat.securesms.contactshare.SharedContactDetailsActivity
import org.gchat.securesms.conversation.AttachmentKeyboardButton
import org.gchat.securesms.conversation.BadDecryptLearnMoreDialog
import org.gchat.securesms.conversation.ConversationAdapter
import org.gchat.securesms.conversation.ConversationBottomSheetCallback
import org.gchat.securesms.conversation.ConversationData
import org.gchat.securesms.conversation.ConversationHeaderView
import org.gchat.securesms.conversation.ConversationIntents
import org.gchat.securesms.conversation.ConversationIntents.ConversationScreenType
import org.gchat.securesms.conversation.ConversationItem
import org.gchat.securesms.conversation.ConversationItemSelection
import org.gchat.securesms.conversation.ConversationItemSwipeCallback
import org.gchat.securesms.conversation.ConversationMessage
import org.gchat.securesms.conversation.ConversationOptionsMenu
import org.gchat.securesms.conversation.ConversationReactionDelegate
import org.gchat.securesms.conversation.ConversationReactionOverlay
import org.gchat.securesms.conversation.ConversationReactionOverlay.OnActionSelectedListener
import org.gchat.securesms.conversation.ConversationReactionOverlay.OnHideListener
import org.gchat.securesms.conversation.ConversationSearchViewModel
import org.gchat.securesms.conversation.ConversationUpdateTick
import org.gchat.securesms.conversation.MarkReadHelper
import org.gchat.securesms.conversation.MenuState
import org.gchat.securesms.conversation.MessageSendType
import org.gchat.securesms.conversation.MessageStyler.getStyling
import org.gchat.securesms.conversation.ReenableScheduledMessagesDialogFragment
import org.gchat.securesms.conversation.ScheduleMessageContextMenu
import org.gchat.securesms.conversation.ScheduleMessageDialogCallback
import org.gchat.securesms.conversation.ScheduleMessageTimePickerBottomSheet
import org.gchat.securesms.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import org.gchat.securesms.conversation.ScheduledMessagesBottomSheet
import org.gchat.securesms.conversation.ScheduledMessagesRepository
import org.gchat.securesms.conversation.SelectedConversationModel
import org.gchat.securesms.conversation.ShowAdminsBottomSheetDialog
import org.gchat.securesms.conversation.colors.ChatColors
import org.gchat.securesms.conversation.colors.Colorizer
import org.gchat.securesms.conversation.colors.RecyclerViewColorizer
import org.gchat.securesms.conversation.drafts.DraftRepository
import org.gchat.securesms.conversation.drafts.DraftRepository.ShareOrDraftData
import org.gchat.securesms.conversation.drafts.DraftViewModel
import org.gchat.securesms.conversation.mutiselect.ConversationItemAnimator
import org.gchat.securesms.conversation.mutiselect.MultiselectItemDecoration
import org.gchat.securesms.conversation.mutiselect.MultiselectPart
import org.gchat.securesms.conversation.mutiselect.forward.MultiselectForwardBottomSheet
import org.gchat.securesms.conversation.mutiselect.forward.MultiselectForwardFragment
import org.gchat.securesms.conversation.mutiselect.forward.MultiselectForwardFragmentArgs
import org.gchat.securesms.conversation.quotes.MessageQuotesBottomSheet
import org.gchat.securesms.conversation.ui.edit.EditMessageHistoryDialog
import org.gchat.securesms.conversation.ui.error.EnableCallNotificationSettingsDialog
import org.gchat.securesms.conversation.ui.inlinequery.InlineQuery
import org.gchat.securesms.conversation.ui.inlinequery.InlineQueryChangedListener
import org.gchat.securesms.conversation.ui.inlinequery.InlineQueryReplacement
import org.gchat.securesms.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import org.gchat.securesms.conversation.ui.inlinequery.InlineQueryViewModelV2
import org.gchat.securesms.conversation.v2.computed.ConversationMessageComputeWorkers
import org.gchat.securesms.conversation.v2.data.AvatarDownloadStateCache
import org.gchat.securesms.conversation.v2.data.ConversationMessageElement
import org.gchat.securesms.conversation.v2.groups.ConversationGroupCallViewModel
import org.gchat.securesms.conversation.v2.groups.ConversationGroupViewModel
import org.gchat.securesms.conversation.v2.items.ChatColorsDrawable
import org.gchat.securesms.conversation.v2.items.InteractiveConversationElement
import org.gchat.securesms.conversation.v2.keyboard.AttachmentKeyboardFragment
import org.gchat.securesms.database.AttachmentTable
import org.gchat.securesms.database.DraftTable
import org.gchat.securesms.database.model.IdentityRecord
import org.gchat.securesms.database.model.InMemoryMessageRecord
import org.gchat.securesms.database.model.Mention
...
import org.gchat.securesms.database.model.Quote
...
import org.gchat.securesms.databinding.V2ConversationFragmentBinding
import org.gchat.securesms.dependencies.AppDependencies
import org.gchat.securesms.events.GroupCallPeekEvent
import org.gchat.securesms.giph.mp4.GiphyMp4ItemDecoration
import org.gchat.securesms.giph.mp4.GiphyMp4PlaybackController
import org.gchat.securesms.giph.mp4.GiphyMp4PlaybackPolicy
import org.gchat.securesms.giph.mp4.GiphyMp4ProjectionPlayerHolder
import org.gchat.securesms.giph.mp4.GiphyMp4ProjectionRecycler
import org.gchat.securesms.groups.GroupId
import org.gchat.securesms.groups.GroupMigrationMembershipChange
import org.gchat.securesms.groups.ui.GroupChangeFailureReason
import org.gchat.securesms.groups.ui.GroupErrors
import org.gchat.securesms.groups.ui.LeaveGroupDialog
import org.gchat.securesms.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import org.gchat.securesms.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import org.gchat.securesms.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import org.gchat.securesms.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import org.gchat.securesms.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import org.gchat.securesms.groups.v2.GroupBlockJoinRequestResult
import org.gchat.securesms.invites.InviteActions
import org.gchat.securesms.jobs.ServiceOutageDetectionJob
import org.gchat.securesms.keyboard.KeyboardPage
import org.gchat.securesms.keyboard.KeyboardPagerFragment
import org.gchat.securesms.keyboard.KeyboardPagerViewModel
import org.gchat.securesms.keyboard.KeyboardUtil
import org.gchat.securesms.keyboard.emoji.EmojiKeyboardPageFragment
import org.gchat.securesms.keyboard.emoji.search.EmojiSearchFragment
import org.gchat.securesms.keyboard.gif.GifKeyboardPageFragment
import org.gchat.securesms.keyboard.sticker.StickerKeyboardPageFragment
import org.gchat.securesms.keyboard.sticker.StickerSearchDialogFragment
import org.gchat.securesms.keyvalue.SignalStore
import org.gchat.securesms.linkpreview.LinkPreview
import org.gchat.securesms.linkpreview.LinkPreviewViewModelV2
import org.gchat.securesms.longmessage.LongMessageFragment
import org.gchat.securesms.mediaoverview.MediaOverviewActivity
import org.gchat.securesms.mediapreview.MediaIntentFactory
import org.gchat.securesms.mediapreview.MediaPreviewV2Activity
import org.gchat.securesms.mediasend.Media
import org.gchat.securesms.mediasend.MediaSendActivityResult
import org.gchat.securesms.messagedetails.MessageDetailsFragment
import org.gchat.securesms.messagerequests.MessageRequestRepository
import org.gchat.securesms.mms.AttachmentManager
import org.gchat.securesms.mms.AudioSlide
import org.gchat.securesms.mms.DocumentSlide
import org.gchat.securesms.mms.GifSlide
import org.gchat.securesms.mms.ImageSlide
import org.gchat.securesms.mms.MediaConstraints
import org.gchat.securesms.mms.QuoteModel
import org.gchat.securesms.mms.Slide
import org.gchat.securesms.mms.SlideDeck
import org.gchat.securesms.mms.SlideFactory
import org.gchat.securesms.mms.StickerSlide
import org.gchat.securesms.mms.VideoSlide
import org.gchat.securesms.nicknames.NicknameActivity
import org.gchat.securesms.notifications.v2.ConversationId
import org.gchat.securesms.payments.preferences.PaymentsActivity
import org.gchat.securesms.permissions.Permissions
import org.gchat.securesms.profiles.manage.EditProfileActivity
import org.gchat.securesms.profiles.spoofing.ReviewCardDialogFragment
import org.gchat.securesms.providers.BlobProvider
import org.gchat.securesms.ratelimit.RecaptchaProofBottomSheetFragment
import org.gchat.securesms.ratelimit.RecaptchaRequiredEvent
import org.gchat.securesms.reactions.ReactionsBottomSheetDialogFragment
import org.gchat.securesms.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
import org.gchat.securesms.recipients.Recipient
import org.gchat.securesms.recipients.RecipientExporter
import org.gchat.securesms.recipients.RecipientId
import org.gchat.securesms.recipients.ui.bottomsheet.RecipientBottomSheetDialogFragment
import org.gchat.securesms.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import org.gchat.securesms.registration.ui.RegistrationActivity
import org.gchat.securesms.revealable.ViewOnceMessageActivity
import org.gchat.securesms.revealable.ViewOnceUtil
import org.gchat.securesms.safety.SafetyNumberBottomSheet
import org.gchat.securesms.sms.MessageSender
import org.gchat.securesms.stickers.StickerEventListener
import org.gchat.securesms.stickers.StickerLocator
import org.gchat.securesms.stickers.StickerManagementActivity
import org.gchat.securesms.stickers.StickerPackInstallEvent
import org.gchat.securesms.stickers.StickerPackPreviewActivity
import org.gchat.securesms.stories.StoryViewerArgs
import org.gchat.securesms.stories.tabs.ConversationListTab
import org.gchat.securesms.stories.viewer.StoryViewerActivity
import org.gchat.securesms.util.BottomSheetUtil
import org.gchat.securesms.util.BubbleUtil
import org.gchat.securesms.util.CommunicationActions
import org.gchat.securesms.util.ContextUtil
import org.gchat.securesms.util.ConversationUtil
import org.gchat.securesms.util.DateUtils
import org.gchat.securesms.util.Debouncer
import org.gchat.securesms.util.DeleteDialog
import org.gchat.securesms.util.Dialogs
import org.gchat.securesms.util.DoubleClickDebouncer
import org.gchat.securesms.util.DrawableUtil
import org.gchat.securesms.util.FullscreenHelper
import org.gchat.securesms.util.MediaUtil
import org.gchat.securesms.util.MessageConstraintsUtil
import org.gchat.securesms.util.MessageConstraintsUtil.getEditMessageThresholdHours
import org.gchat.securesms.util.MessageConstraintsUtil.isValidEditMessageSend
import org.gchat.securesms.util.PlayStoreUtil
import org.gchat.securesms.util.RemoteConfig
import org.gchat.securesms.util.SaveAttachmentUtil
import org.gchat.securesms.util.SignalLocalMetrics
import org.gchat.securesms.util.StorageUtil
import org.gchat.securesms.util.TextSecurePreferences
import org.gchat.securesms.util.ViewUtil
import org.gchat.securesms.util.WindowUtil
import org.gchat.securesms.util.atMidnight
import org.gchat.securesms.util.atUTC
import org.gchat.securesms.util.createActivityViewModel
import org.gchat.securesms.util.doAfterNextLayout
import org.gchat.securesms.util.fragments.requireListener
import org.gchat.securesms.util.getQuote
import org.gchat.securesms.util.getRecordQuoteType
import org.gchat.securesms.util.hasAudio
import org.gchat.securesms.util.hasGiftBadge
import org.gchat.securesms.util.hasNonTextSlide
import org.gchat.securesms.util.isValidReactionTarget
import org.gchat.securesms.util.padding
import org.gchat.securesms.util.savedStateViewModel
import org.gchat.securesms.util.setIncognitoKeyboardEnabled
import org.gchat.securesms.util.toMillis
import org.gchat.securesms.util.viewModel
import org.gchat.securesms.util.views.Stub
import org.gchat.securesms.util.visible
import org.gchat.securesms.verify.VerifyIdentityActivity
import org.gchat.securesms.wallpaper.ChatWallpaper
import org.gchat.securesms.wallpaper.ChatWallpaperDimLevelUtil
