...
import org.gchat.securesms.mediasend.camerax.CameraXFlashToggleView;
import org.gchat.securesms.mediasend.camerax.CameraXModePolicy;
import org.gchat.securesms.mediasend.camerax.CameraXUtil;
import org.gchat.securesms.mediasend.v2.MediaAnimations;
import org.gchat.securesms.mediasend.v2.MediaCountIndicatorButton;
...
import org.gchat.securesms.util.MemoryFileDescriptor;
import org.gchat.securesms.util.TextSecurePreferences;
import org.gchat.securesms.util.ViewUtil;
import org.gchat.securesms.video.VideoUtil;
...
import static org.gchat.securesms.permissions.PermissionDeniedBottomSheet.showPermissionFragment;
  ...
  private void displayVideoRecordingTooltipIfNecessary(CameraButtonView captureButton) {
    if (shouldDisplayVideoRecordingTooltip()) {
      ...
      TooltipPopup.forTarget(captureButton)
                  ...
                  .setBackgroundTint(ContextCompat.getColor(requireContext(), R.color.core_green_accent))
