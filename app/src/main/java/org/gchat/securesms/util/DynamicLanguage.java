...
import org.gchat.securesms.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link org.gchat.securesms.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
