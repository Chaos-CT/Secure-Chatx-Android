...
class AndroidCallConnectionService : ConnectionService() {
  ...
  companion object {
    ...
    const val KEY_RECIPIENT_ID = "org.gchat.securesms.RECIPIENT_ID"
    const val KEY_CALL_ID = "org.gchat.securesms.CALL_ID"
    const val KEY_VIDEO_CALL = "org.gchat.securesms.VIDEO_CALL"
  }
