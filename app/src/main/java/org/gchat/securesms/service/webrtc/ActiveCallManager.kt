...
import org.gchat.securesms.service.SafeForegroundService
...
import org.gchat.securesms.webrtc.UncaughtExceptionHandlerManager
import org.gchat.securesms.webrtc.audio.AudioManagerCommand
import org.gchat.securesms.webrtc.audio.SignalAudioManager
import org.gchat.securesms.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "org.gchat.securesms.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "org.gchat.securesms.service.webrtc.ActiveCallAction.HANGUP"
    }
