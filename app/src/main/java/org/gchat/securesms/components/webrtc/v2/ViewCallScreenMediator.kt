...
import org.gchat.securesms.components.webrtc.CallOverflowPopupWindow
import org.gchat.securesms.components.webrtc.CallParticipantListUpdate
import org.gchat.securesms.components.webrtc.CallParticipantsListUpdatePopupWindow
import org.gchat.securesms.components.webrtc.CallParticipantsState
import org.gchat.securesms.components.webrtc.CallStateUpdatePopupWindow
import org.gchat.securesms.components.webrtc.WebRtcCallView
import org.gchat.securesms.components.webrtc.WebRtcControls
import org.gchat.securesms.components.webrtc.WifiToCellularPopupWindow
import org.gchat.securesms.components.webrtc.controls.ControlsAndInfoController
import org.gchat.securesms.components.webrtc.controls.ControlsAndInfoViewModel
...
class ViewCallScreenMediator(
  ...
  override fun showVideoTooltip(): Dismissible {
    val tooltip = TooltipPopup.forTarget(callScreen.videoTooltipTarget)
      .setBackgroundTint(ContextCompat.getColor(activity, R.color.core_green_accent))
