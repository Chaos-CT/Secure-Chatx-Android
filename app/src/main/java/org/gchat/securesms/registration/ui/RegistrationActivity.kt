...
class RegistrationActivity : BaseActivity() {
  ...
  companion object {
    ...
    private fun getRegistrationClass(): Class<*> {
      return if (RemoteConfig.restoreAfterRegistration) org.gchat.securesms.registrationv3.ui.RegistrationActivity::class.java else RegistrationActivity::class.java
    }
  }
}
