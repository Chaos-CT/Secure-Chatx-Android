...
import org.gchat.securesms.database.model.StickerPackRecord;
import org.gchat.securesms.glide.cache.ApngOptions;
...
import org.gchat.securesms.util.adapter.SectionedRecyclerViewAdapter;
import org.gchat.securesms.util.adapter.StableIdGenerator;
...
final class StickerManagementAdapter extends SectionedRecyclerViewAdapter<String, StickerManagementAdapter.StickerSection> {
  ...
  static class StickerViewHolder extends RecyclerView.ViewHolder {
    ...
    private static @NonNull CharSequence buildBlessedBadge(@NonNull Context context) {
      ...
      DrawableUtil.tint(badge, ContextCompat.getColor(context, R.color.core_green_accent));
