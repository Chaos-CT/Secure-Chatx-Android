...
package org.gchat.securesms.backup.v2.exporters
...
import org.gchat.securesms.backup.v2.ExportOddities
import org.gchat.securesms.backup.v2.ExportSkips
import org.gchat.securesms.backup.v2.ExportState
import org.gchat.securesms.backup.v2.proto.ChatItem
import org.gchat.securesms.backup.v2.proto.ChatUpdateMessage
import org.gchat.securesms.backup.v2.proto.ContactAttachment
import org.gchat.securesms.backup.v2.proto.ContactMessage
import org.gchat.securesms.backup.v2.proto.DirectStoryReplyMessage
import org.gchat.securesms.backup.v2.proto.ExpirationTimerChatUpdate
import org.gchat.securesms.backup.v2.proto.GenericGroupUpdate
import org.gchat.securesms.backup.v2.proto.GroupCall
import org.gchat.securesms.backup.v2.proto.GroupChangeChatUpdate
import org.gchat.securesms.backup.v2.proto.GroupExpirationTimerUpdate
import org.gchat.securesms.backup.v2.proto.GroupV2MigrationUpdate
import org.gchat.securesms.backup.v2.proto.IndividualCall
import org.gchat.securesms.backup.v2.proto.LearnedProfileChatUpdate
import org.gchat.securesms.backup.v2.proto.MessageAttachment
import org.gchat.securesms.backup.v2.proto.PaymentNotification
import org.gchat.securesms.backup.v2.proto.ProfileChangeChatUpdate
import org.gchat.securesms.backup.v2.proto.Quote
import org.gchat.securesms.backup.v2.proto.Reaction
import org.gchat.securesms.backup.v2.proto.RemoteDeletedMessage
import org.gchat.securesms.backup.v2.proto.SendStatus
import org.gchat.securesms.backup.v2.proto.SessionSwitchoverChatUpdate
import org.gchat.securesms.backup.v2.proto.SimpleChatUpdate
import org.gchat.securesms.backup.v2.proto.StandardMessage
import org.gchat.securesms.backup.v2.proto.Sticker
import org.gchat.securesms.backup.v2.proto.StickerMessage
import org.gchat.securesms.backup.v2.proto.Text
import org.gchat.securesms.backup.v2.proto.ThreadMergeChatUpdate
import org.gchat.securesms.backup.v2.proto.ViewOnceMessage
import org.gchat.securesms.backup.v2.util.clampToValidBackupRange
import org.gchat.securesms.backup.v2.util.toRemoteFilePointer
...
import org.gchat.securesms.database.MessageTypes
import org.gchat.securesms.database.PaymentTable
import org.gchat.securesms.database.SignalDatabase
import org.gchat.securesms.database.documents.IdentityKeyMismatchSet
import org.gchat.securesms.database.documents.NetworkFailureSet
import org.gchat.securesms.database.model.GroupCallUpdateDetailsUtil
import org.gchat.securesms.database.model.GroupsV2UpdateMessageConverter
...
import org.gchat.securesms.database.model.databaseprotos.DecryptedGroupV2Context
import org.gchat.securesms.database.model.databaseprotos.GiftBadge
import org.gchat.securesms.database.model.databaseprotos.MessageExtras
import org.gchat.securesms.database.model.databaseprotos.ProfileChangeDetails
import org.gchat.securesms.database.model.databaseprotos.SessionSwitchoverEvent
import org.gchat.securesms.database.model.databaseprotos.ThreadMergeEvent
...
import org.gchat.securesms.payments.FailureReason
import org.gchat.securesms.payments.State
import org.gchat.securesms.recipients.RecipientId
import org.gchat.securesms.util.JsonUtils
...
import org.gchat.securesms.backup.v2.proto.BodyRange as BackupBodyRange
import org.gchat.securesms.backup.v2.proto.GiftBadge as BackupGiftBadge
...
private fun LinkPreview.toRemoteLinkPreview(mediaArchiveEnabled: Boolean): org.gchat.securesms.backup.v2.proto.LinkPreview {
  return org.gchat.securesms.backup.v2.proto.LinkPreview(
    url = url,
