  ...
  override fun onCreate() {
    ...
    LeakCanary.config = LeakCanary.config.copy(
      referenceMatchers = AndroidReferenceMatchers.appDefaults +
        ...
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gchat.securesms.components.voice.VoiceNotePlaybackService",
          fieldName = "mApplication"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gchat.securesms.service.GenericForegroundService\$LocalBinder",
          fieldName = "this\$0"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "org.gchat.securesms.contacts.ContactsSyncAdapter",
          fieldName = "mContext"
        )
    )
  }
