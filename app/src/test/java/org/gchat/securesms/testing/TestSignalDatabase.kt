...
class TestSignalDatabase(
  ...
  override val signalReadableDatabase: org.gchat.securesms.database.SQLiteDatabase by lazy {
    TestSignalSQLiteDatabase(supportReadableDatabase)
  }

  override val signalWritableDatabase: org.gchat.securesms.database.SQLiteDatabase by lazy {
